...
addr = isotp.AsymmetricAddress(
    tx_addr=isotp.Address(isotp.AddressingMode.NormalFixed_29bits, target_address=TX_TARGET_ADDR, source_address=TX_SOURCE_ADDR, tx_only=True),
    rx_addr=isotp.Address(isotp.AddressingMode.NormalFixed_29bits, target_address=RX_TARGET_ADDR, source_address=RX_SOURCE_ADDR, rx_only=True)   # txid is not required
)
params = {
    'blocking_send' : True,
    'tx_padding': 0x00
